...
image: "src/assets/images/redpanda.jpeg"
---

import Figure from "../../components/Figure.astro";
import RedPandaImg from '../../assets/images/redpanda.jpeg'
import ZoomImg from '../../assets/images/zoom.png';
import TD1Img from '../../assets/images/3d-1.gif';
import EuclideanImg from '../../assets/images/euclidean_distance.png';
import WorkingImg from '../../assets/images/working.png';
import DrawbacksImg from '../../assets/images/drawbacks.png';
...
We're looking to find distinct groups of similar colours, to do this we'll use what's known as k-means clustering[^1] we're going to use the naïve k-means which is one of the more simple versions of the algorithm and is unoptimized. The basic steps are as follows:
